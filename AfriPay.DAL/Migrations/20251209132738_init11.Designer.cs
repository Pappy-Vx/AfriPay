...
namespace AfriPay.DAL.Migrations
{
    ...
    [Migration("20251209132738_init11")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AfriPay.CORE.Entities.Customer", b =>
                {
                    ...
                    b.Property<string>("TransferPinHash")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                    ...
                    b.HasIndex("IdentityNumber", "IdentityType")
                        .IsUnique()
            ...
            modelBuilder.Entity("AfriPay.CORE.Entities.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AfriPay.CORE.Entities.Transfer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");
                    ...
                    b.Property<string>("DestinationUserTag")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("AfriPay.CORE.Entities.Transaction", b =>
                {
                    b.OwnsOne("AfriPay.CORE.ValueObjects.Money", "Amount", b1 =>
                        {
            ...
            modelBuilder.Entity("AfriPay.CORE.Entities.Transfer", b =>
                {
                    ...
                    b.OwnsOne("AfriPay.CORE.ValueObjects.Money", "Fee", b1 =>
                        {
                            b1.Property<Guid>("TransferId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("AfriPay.CORE.ValueObjects.Money", "TotalDebitAmount", b1 =>
                        {
                            b1.Property<Guid>("TransferId")
                                .HasColumnType("uniqueidentifier");
