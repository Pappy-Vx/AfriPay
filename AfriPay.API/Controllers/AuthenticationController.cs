...
namespace AfriPay.API.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        /// </summary>
        /// <remarks>
        /// This endpoint authenticates a customer using their email and password, returning a JWT access token upon success.
        /// 
        /// **Request Body (LoginCommand):**
        /// - Email: Customer's email address (required, string). Must be a valid email format with '@' symbol.
        ...
        /// <response code="400">Bad request - validation errors (invalid email format, password too short)</response>
